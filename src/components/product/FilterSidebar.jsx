...
export default function FilterSidebar({ filters, onFilterChange }) {
  ...
  const types = ['Dressage', 'Show Jumping', 'All Purpose', 'Endurance', 'Western', 'Eventing'];
  const sizes = ['16', '16.5', '17', '17.5', '18', '18.5'];
  const materials = ['Leather', 'Synthetic', 'Mixed'];
      ...
      <div className="mb-6 lg:mb-8">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm text-text-secondary">
            <span>Min: ${activeFilters.priceRange[0].toLocaleString('en-US')}</span>
            <span>Max: ${activeFilters.priceRange[1].toLocaleString('en-US')}</span>
          </div>
          <input
            type="range"
            min="0"
