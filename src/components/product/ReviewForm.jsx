...
export default function ReviewForm({ productId, onReviewSubmitted }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert('Your review was submitted and will appear after moderation. Thank you!');
    } catch (error) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Share your experience with this saddle..."
          />
        </div>
        ...
        <div>
          ...
          {imagePreview ? (
            ...
            <label className="inline-flex items-center gap-2 px-4 py-2 border border-border rounded-md bg-background hover:bg-muted transition-fast cursor-pointer">
              ...
              <span className="text-sm text-text-primary">Add a photo</span>
              <input
                type="file"
                accept="image/*"
          ...
          <p className="text-xs text-text-secondary mt-1">Max 5MB. Formats: JPG, PNG</p>
        </div>
