...
export default function Footer() {
  ...
  const faqData = [
    {
      ...
      answer: 'La misura della sella dipende dalla lunghezza della coscia del cavaliere e dalla conformazione del cavallo. Una sella troppo piccola limita la libert├á di movimento, mentre una troppo grande pu├▓ causare instabilit├á. Consigliamo sempre di provare la sella prima dell\'acquisto e, se possibile, farsi consigliare da un sellaro professionista che valuter├á sia le tue esigenze che quelle del tuo cavallo.',
    },
    {
      question: 'Qual ├¿ la differenza tra una sella da dressage e una da salto?',
      answer: 'Le selle da dressage hanno boccagli pi├╣ lunghi e profondi per favorire una posizione pi├╣ seduta e allungata, ideale per l\'addestramento classico. Le selle da salto hanno boccagli pi├╣ corti e piatti, con pannelli pi├╣ corti per permettere al cavallo maggiore libert├á di movimento durante gli ostacoli. La scelta dipende dalla disciplina che pratichi.',
    },
    {
      question: 'Quanto spesso devo fare la manutenzione della sella?',
      answer: 'La manutenzione regolare ├¿ fondamentale per preservare la qualit├á e la durata della sella. Consigliamo di pulire la sella dopo ogni utilizzo con prodotti specifici per il cuoio, controllare mensilmente le cuciture e le fibbie, e fare una revisione completa da un sellaro almeno una volta all\'anno. Una sella ben curata pu├▓ durare decenni.',
    },
    {
      question: 'Le selle in pelle sintetica sono una buona alternativa?',
      answer: 'Le selle sintetiche sono pi├╣ economiche e facili da pulire, ideali per principianti o per uso intensivo. Tuttavia, le selle in pelle naturale offrono maggiore comfort, durata e adattabilit├á nel tempo. La pelle si modella naturalmente al cavallo e al cavaliere, creando un\'esperienza di guida superiore. Per un investimento a lungo termine, consigliamo sempre la pelle naturale.',
    },
    {
      question: 'Come capisco se la sella calza bene al mio cavallo?',
      answer: 'Una sella ben adattata non deve creare punti di pressione, deve permettere il passaggio di due dita tra il pomello e il garrese, e deve distribuire uniformemente il peso. Segnali di una sella non adatta includono: scollature, zone di sudore asimmetriche, comportamento irrequieto del cavallo, o difficolt├á nel mantenere l\'equilibrio. Un sellaro professionista pu├▓ valutare l\'adattamento con precisione.',
    },
    {
      question: 'Cosa significa "sella su misura"?',
      answer: 'Una sella su misura viene costruita specificamente per le misure del tuo cavallo e le tue esigenze personali. Questo processo include la presa delle impronte del dorso del cavallo, la scelta del tipo di pannelli, la forma del boccaglio e altri dettagli personalizzati. ├ê l\'opzione migliore per cavalli con conformazioni particolari o cavalieri che cercano la perfezione assoluta.',
    },
    {
      question: 'Quanto tempo serve per "rompere" una nuova sella?',
      answer: 'Una nuova sella richiede un periodo di rodaggio di circa 20-30 ore di utilizzo per adattarsi completamente al dorso del cavallo. Durante questo periodo, ├¿ importante controllare regolarmente che non si formino punti di pressione e alternare l\'uso con la vecchia sella se possibile. La pazienza in questa fase garantir├á anni di comfort.',
    },
    {
      question: 'Le selle usate sono una buona scelta?',
      answer: 'Le selle usate possono essere un\'ottima opzione se sono in buone condizioni e ben adattate. Controlla sempre le cuciture, lo stato del cuoio, l\'integrit├á dell\'albero e la presenza di eventuali crepe. Una sella usata di qualit├á, magari di una marca prestigiosa, pu├▓ offrire un rapporto qualit├á-prezzo eccellente rispetto a una nuova di fascia media.',
    },
  ];
  ...
  const articles = [
    {
      ...
      category: 'Selle',
      excerpt: 'Scopri come selezionare la sella ideale per te e il tuo cavallo. Una guida approfondita che ti aiuter├á a fare la scelta giusta.',
      content: 'La scelta della sella ├¿ uno degli aspetti pi├╣ importanti nell\'equitazione. Una sella ben adattata non solo garantisce comfort per il cavaliere, ma anche benessere per il cavallo. In questa guida completa, esploreremo tutti i fattori da considerare: dalla misura corretta alla conformazione del cavallo, dal tipo di disciplina praticata alla qualit├á dei materiali. Imparerai a riconoscere i segnali di una sella non adatta e come collaborare con un sellaro professionista per trovare la soluzione perfetta.',
    ...
    },
    {
      ...
      content: 'Una sella ben curata pu├▓ durare una vita intera. La manutenzione regolare ├¿ essenziale per preservare la qualit├á del cuoio, mantenere la flessibilit├á e prevenire crepe o danni strutturali. In questo articolo, condivideremo i segreti dei sellari professionisti: dalla pulizia quotidiana alle tecniche di condizionamento, dalla protezione contro gli agenti atmosferici alla conservazione durante i periodi di inattivit├á. Scoprirai anche quali prodotti utilizzare e quali evitare per non danneggiare il cuoio pregiato.',
    ...
    },
    {
      ...
      content: 'Ogni disciplina equestre richiede attrezzature specifiche progettate per ottimizzare le performance. Le selle da dressage sono caratterizzate da boccagli lunghi e profondi che favoriscono una posizione seduta e allungata, essenziale per l\'addestramento classico. Al contrario, le selle da salto hanno boccagli pi├╣ corti e piatti, con pannelli ridotti che permettono maggiore libert├á di movimento durante gli ostacoli. Questo articolo approfondisce le caratteristiche tecniche, i vantaggi di ciascun tipo e come scegliere in base al tuo livello e alle tue aspirazioni competitive.',
    ...
    },
    {
      ...
      excerpt: 'Scopri perch├® un adattamento corretto ├¿ fondamentale per la salute del tuo cavallo e come riconoscere i problemi.',
      content: 'Una sella mal adattata pu├▓ causare seri problemi di salute al cavallo, inclusi dolori muscolari, scollature e persino problemi comportamentali. L\'adattamento corretto non ├¿ solo una questione di comfort, ma di benessere equino. Questo articolo ti guider├á attraverso i segnali da osservare: zone di sudore asimmetriche, comportamento irrequieto, difficolt├á nel mantenere l\'andatura. Imparerai anche come un sellaro professionista valuta l\'adattamento utilizzando tecniche specifiche e perch├® investire in una sella su misura pu├▓ essere la scelta migliore per cavalli con conformazioni particolari.',
    ...
    },
    {
      ...
      category: 'Acquisti',
      excerpt: 'Tutto quello che devi sapere prima di acquistare una sella usata. Come valutare qualit├á, condizioni e valore.',
      content: 'Acquistare una sella usata pu├▓ essere un\'ottima scelta economica, ma richiede attenzione e conoscenza. In questa guida completa, ti insegneremo come ispezionare una sella usata: controllare l\'integrit├á dell\'albero, valutare lo stato del cuoio, verificare le cuciture e identificare eventuali danni nascosti. Scoprirai anche come riconoscere una sella di qualit├á anche se usata, quali marche mantengono meglio il valore nel tempo, e quando ├¿ meglio investire in una sella nuova piuttosto che usata. Con i nostri consigli, farai un acquisto consapevole e sicuro.',
  ...
  const footerLinks = {
    navigazione: [
      { label: 'Disponibili', href: '/product-catalog' },
        ...
        <div className="py-12 border-b border-border">
          <div className="mb-8">
            ...
            <p className="text-text-secondary text-sm sm:text-base">
              Trova risposte alle domande pi├╣ comuni sull'equitazione e la scelta della sella perfetta
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-sm text-text-secondary leading-relaxed mb-4">
                Specialisti in selle di alta qualit├á per l'equitazione. La tua passione, la nostra esperienza.
              </p>
