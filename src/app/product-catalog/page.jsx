      ...
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-6 py-6 sm:py-8">
        ...
        <div className="mb-8 sm:mb-10">
          ...
          <p className="text-base sm:text-lg text-text-secondary leading-relaxed max-w-2xl">
            Discover our selection of riding saddles from trusted makers, chosen for quality, comfort, and performance.
          </p>
        </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-4 sm:mb-6">
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                >
                  ...
                  <span className="text-sm font-body">Filters</span>
                </button>
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <label className="text-xs sm:text-sm text-text-secondary whitespace-nowrap">Sort by:</label>
                <select
                  value={sortBy}
