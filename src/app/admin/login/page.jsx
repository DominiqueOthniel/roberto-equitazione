...
export default function AdminLoginPage() {
  ...
  const [email, setEmail] = useState('madisoncook906@gmail.com');
  ...
  const handleSubmit = (e) => {
    ...
    const ADMIN_EMAILS = ['madisoncook906@gmail.com', 'admin@robertoequitazione.it'];
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-stone-50 to-amber-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-serif font-bold text-amber-900">MADISON</h1>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="madisoncook906@gmail.com"
                  required
                />
              </div>
            </div>
