    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-container mx-auto px-4 lg:px-6 py-8">
        ...
        <div className="mb-6 text-sm text-text-secondary">
          <Link href="/product-catalog" className="hover:text-primary">Shop</Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="mb-6 p-4 bg-surface rounded-lg">
              <h3 className="font-heading font-semibold text-text-primary mb-3">Technical Specs</h3>
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  <span className="text-text-secondary">Seat size:</span>
                  <span className="font-semibold text-text-primary ml-2">{product.technicalSpecs.misuraSedile}</span>
                </div>
                <div>
                  <span className="text-text-secondary">Tree width:</span>
                  <span className="font-semibold text-text-primary ml-2">{product.technicalSpecs.larghezzaArcione}</span>
                </div>
                <div>
                  <span className="text-text-secondary">Flap length:</span>
            ...
            {/* Features */}
            <div className="mb-6">
              <h3 className="font-heading font-semibold text-text-primary mb-3">Key Features</h3>
            ...
            <div className="bg-surface border border-border rounded-lg p-6">
              ...
              <div className="space-y-3 mb-6">
                ...
                <button
                  ...
                  className="w-full bg-surface border-2 border-primary text-primary py-3 px-6 rounded-md font-body font-semibold hover:bg-muted transition-fast flex items-center justify-center gap-2"
                >
              ...
              <div className="space-y-3 pt-6 border-t border-border">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-body font-semibold text-text-primary">Free Shipping</p>
                    <p className="text-sm text-text-secondary">On orders over $150 within the United States</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-body font-semibold text-text-primary">Free Returns</p>
                    <p className="text-sm text-text-secondary">Within 30 days of purchase</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-success flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <div>
                    <p className="font-body font-semibold text-text-primary">2-Year Warranty</p>
                  </div>
                </div>
              </div>
            </div>
